    ...
    public function run(): void
    {
        ...
        $roles = [
            [
                ...
                'permissions' => [
                    'gestionar_usuarios.view',
                    'gestionar_usuarios.create',
                    'gestionar_usuarios.edit',
                    'gestionar_usuarios.delete',
                    'gestionar_roles.view',
                    'gestionar_roles.create',
                    'gestionar_roles.edit',
                    'gestionar_roles.delete',
                    'unidades.view',
                    'unidades.create',
                    'unidades.edit',
                    'unidades.delete',
