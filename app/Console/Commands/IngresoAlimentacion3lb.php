...
class IngresoAlimentacion3lb extends Command
{
    protected $signature = 'alimentacion:3lb';
    protected $description = 'Genera registros de alimentación de 3 lb por hora en los horarios y fechas indicados';
    ...
    public function handle()
    {
        ...
        $horas = [6, 9, 12, 15, 17];
        $fecha_inicio = Carbon::create(2025, 5, 1);
        $fecha_fin = Carbon::create(2025, 6, 30);
