...
class IngresoAlimentacionPersonalizado extends Command
{
    protected $signature = 'alimentacion:personalizada';
    protected $description = 'Genera registros de alimentación según parámetros personalizados';
