        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center">
                ...
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    {{ __('Módulo de Ventas y Cosechas') }}
                </h2>
            </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="lg:col-span-3">
                    <!-- Estadísticas rápidas o información adicional pueden ir aquí -->
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="text-center">
                                <div class="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{{ $cosechasEsteMes ?? 0 }}</div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Cosechas Este Mes</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">Q{{ number_format($ventasEsteMes ?? 0, 2) }}</div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Ventas Este Mes</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ $clientesActivos ?? 0 }}</div>
            ...
            <!-- Submódulos del Módulo Ventas -->
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-6">Submódulos de Ventas y Cosechas</h3>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Submódulo Cosechas Parciales -->
                        <div class="group relative">
                            <a href="{{ route('produccion.cosechas.index') }}" class="block">
                                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/30 dark:to-emerald-800/30 rounded-xl p-6 border border-emerald-200 dark:border-emerald-700 hover:shadow-lg transition-all duration-300 group-hover:scale-105">
                                    ...
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Cosechas Parciales</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Registro y control de cosechas parciales por lote</p>
                                    
                                    <!-- Funciones disponibles -->
                                    <div class="mt-4 pt-4 border-t border-emerald-200 dark:border-emerald-700">
                                        <p class="text-xs text-emerald-600 dark:text-emerald-400 font-medium mb-2">Funciones disponibles:</p>
                        ...
                        <div class="group relative">
                            <a href="{{ route('ventas.index') }}" class="block">
                                <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/30 dark:to-indigo-800/30 rounded-xl p-6 border border-indigo-200 dark:border-indigo-700 hover:shadow-lg transition-all duration-300 group-hover:scale-105">
                                    <div class="flex items-center justify-between mb-4">
                                    ...
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Gestión de Ventas</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Control de ventas, clientes y comercialización</p>
                                    
                                    <!-- Funciones disponibles -->
                                    <div class="mt-4 pt-4 border-t border-indigo-200 dark:border-indigo-700">
                                        <p class="text-xs text-indigo-600 dark:text-indigo-400 font-medium mb-2">Funciones disponibles:</p>
                                        <div class="flex flex-wrap gap-2">
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-300">
                                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
