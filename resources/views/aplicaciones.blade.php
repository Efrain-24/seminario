    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                @php
                    $moduleDefinitions = [
                        // Restaurar colores originales pero mantener gradiente cruzado y borde azul
                        'reportes' => [
                            'name' => 'Reportes',
                            'description' => 'Reportes de ganancias, costos y análisis financiero',
                            'icon' => '<i data-lucide="bar-chart-3"></i>',
                            'route' => 'reportes.ganancias',
                            'color' => 'bg-none border-2 border-gray-800',
                            'forceStyle' => 'background: linear-gradient(135deg, #434343 0%, #232526 100%); color: #fff; border: 2px solid #232526;',
                        ],
                        'unidades' => [
                            'name' => 'Unidades',
                            ...
                            'color' => 'from-blue-500 to-blue-700 bg-gradient-to-br border-2 border-blue-400',
                        ],
                        'produccion' => [
                            'name' => 'Producción',
                            ...
                            'color' => 'from-green-500 to-emerald-600 bg-gradient-to-br border-2 border-blue-400',
                        ],
                        'inventarios' => [
                            'name' => 'Inventarios',
                            ...
                            'color' => 'from-amber-500 to-orange-600 bg-gradient-to-br border-2 border-blue-400',
                        ],
                        'usuarios_roles' => [
                            ...
                            'color' => 'from-purple-500 to-indigo-600 bg-gradient-to-br border-2 border-blue-400',
                        ],
                        'acciones_correctivas' => [
                            ...
                            'color' => 'from-red-500 to-pink-600 bg-gradient-to-br border-2 border-blue-400',
                        ],
                        'protocolos_limpieza' => [
                            ...
                            'color' => 'from-indigo-500 to-indigo-700 bg-gradient-to-br border-2 border-blue-400',
                        ],
                        'ventas' => [
                            ...
                            'route' => 'ventas.panel',
                            'color' => 'from-emerald-500 to-teal-600 bg-gradient-to-br border-2 border-blue-400',
                        ],
                        'compras_proveedores' => [
                            ...
                            'route' => 'compras.panel',
                            'color' => 'from-cyan-500 to-blue-600 bg-gradient-to-br border-2 border-blue-400',
                        ],
                    ];
                @endphp
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        @foreach ($userModules as $key => $module)
                            <div
                                ...
                                @if($key === 'reportes' && !empty($module['forceStyle'])) style="{{ $module['forceStyle'] }}" @endif
                                ...
                                <div class="relative z-10">
                                    <h4 class="text-lg font-bold mb-1">{{ $module['name'] ?? 'Reportes' }}</h4>
                                    <p class="text-sm opacity-90">{{ $module['description'] ?? 'Reportes de ganancias, costos y análisis financiero' }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
