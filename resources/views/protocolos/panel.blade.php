<x-app-layout>
        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center">
                ...
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    {{ __('Módulo de Protocolos y Limpieza') }}
                </h2>
            </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <!-- Submódulos del Módulo Protocolos -->
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-6">Submódulos de Protocolos y Limpieza</h3>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Submódulo Protocolos de Sanidad -->
                        <div class="group relative">
                            <a href="{{ route('protocolo-sanidad.index') }}" class="block">
                                <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl p-6 border border-blue-200 dark:border-blue-700 hover:shadow-lg transition-all duration-300 group-hover:scale-105">
                                    ...
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Protocolos de Sanidad</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Gestión completa de protocolos de sanidad acuícola</p>
                        ...
                        <!-- Submódulo Limpieza -->
                        <div class="group relative">
                            <a href="{{ route('limpieza.index') }}" class="block">
                                <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 rounded-xl p-6 border border-green-200 dark:border-green-700 hover:shadow-lg transition-all duration-300 group-hover:scale-105">
                                    ...
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Registro de Limpiezas</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Control y seguimiento de actividades de limpieza</p>
