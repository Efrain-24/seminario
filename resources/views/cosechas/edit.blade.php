<x-app-layout>
    ...
    <div class="py-8 max-w-3xl mx-auto px-4">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded p-4">
            <form action="{{ route('produccion.cosechas.update', $cosecha) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                @include('cosechas._form', ['cosecha' => $cosecha, 'lotes' => $lotes])
