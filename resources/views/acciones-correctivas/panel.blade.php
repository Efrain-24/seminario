<x-app-layout>
        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center">
                ...
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    {{ __('Módulo de Acciones Correctivas') }}
                </h2>
            </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <!-- Submódulos del Módulo Acciones Correctivas -->
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-6">Submódulos de Acciones Correctivas</h3>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Submódulo No Conformidades -->
                        <div class="group relative">
                            <a href="{{ route('acciones_correctivas.index') }}" class="block">
                                <div class="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-800/30 rounded-xl p-6 border border-red-200 dark:border-red-700 hover:shadow-lg transition-all duration-300 group-hover:scale-105">
                                    ...
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">No Conformidades</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Registro y seguimiento de no conformidades del sistema</p>
                                    
                                    <!-- Funciones disponibles -->
                                    <div class="mt-4 pt-4 border-t border-red-200 dark:border-red-700">
                                        <p class="text-xs text-red-600 dark:text-red-400 font-medium mb-2">Funciones disponibles:</p>
                        ...
                        <!-- Submódulo Acciones Correctivas -->
                        <div class="group relative">
                            <a href="{{ route('acciones_correctivas.index') }}" class="block">
                                <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/30 dark:to-yellow-800/30 rounded-xl p-6 border border-yellow-200 dark:border-yellow-700 hover:shadow-lg transition-all duration-300 group-hover:scale-105">
                                    ...
                                    <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Acciones Correctivas</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Planificación y ejecución de acciones correctivas</p>
